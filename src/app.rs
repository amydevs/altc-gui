...
pub fn app() -> Html {
    ...
    let converted_ask_results = use_memo([asks.clone()], |_| {
            ...
            <div class="pb-0 flex">
                <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-6 space-y-3 flex-1">
                    ...
                    <div>
                        ...
                        <select name="default-version-to" class="p-1 bg-background border" onchange={{
                            let default_version_to = default_version_to.clone();
            ...
            <div class="flex sm:flex-row flex-col gap-6 flex-1">
                <div class="flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm flex-1 min-h-[320px]">
                    <div class="border-b p-6 flex justify-between">
                        ...
                        />
                        <label class="flex items-center justify-center cursor-pointer" title="Upload .ask files" tabindex="0" for="uploader">
